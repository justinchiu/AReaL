...
# Import reward function from frontierco
...
def main(args):
    ...
    # Note: deployment parameter for swerex will be None, uses fallback
    # To enable swerex, you would need to initialize and pass deployment here
